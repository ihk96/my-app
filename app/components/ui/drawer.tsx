      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Sizing.
            "[--drawer-content-height:var(--drawer-height,auto)] data-[swipe-axis=x]:[--drawer-content-width:75%] data-[swipe-axis=y]:[--drawer-content-max-height:calc(100vh-6rem)] data-[swipe-axis=y]:data-snap-points:[--drawer-content-height:100vh] data-[swipe-axis=x]:sm:[--drawer-content-width:24rem]",
            // Stack.
